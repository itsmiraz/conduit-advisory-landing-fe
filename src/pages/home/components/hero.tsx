  ...
  return (
    <div>
      <div className="md:heroBg max-w-[1340px] gap-y-[25px] md:h-[717px] mx-auto overflow-hidden px-[32px] md:px-[77px] py-5 rounded-[34px] md:flex-row flex-col-reverse flex justify-between items-center">
        ...
        >
          ...
          <a href="#contact">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="bg-[#B7995B] w-full md:w-fit justify-between md:justify-center rounded-[12px] text-[16px] md:text-xl font-semibold flex gap-x-3 px-[14px] md:px-[26px] py-[8px] md:py-[14px] text-white"
            >
        ...
        {/* Right Image */}
        <motion.div
          className="max-w-[600px] px-4 md:px-0"
