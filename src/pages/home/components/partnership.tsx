  ...
  return (
    <div className="max-w-[1263px] px-4 mt-32 flex md:flex-row flex-col-reverse items-center justify-between gap-10 mx-auto">
      <div className="md:w-[578px]">
        <div className="bg-[#FFFDFD] border-[#E6E6E6] border w-fit rounded-[24px] px-[18px] md:px-[24px] py-[9px] md:py-[12px] flex gap-x-2 items-center">
          <RadioButton />
        ...
        <h2 className="text-[20px] md:text-[36px] mt-[14px] mb-[24px]  font-bold text-desc ">
          Partnerships Built for the <br /> Next Economy
        </h2>
        <p className="text-[14px] md:text-[16px] text-desc">
